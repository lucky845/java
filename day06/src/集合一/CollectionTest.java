...
//        coll.add(p);
        ...
        // 我们在判断的时候会调用obj对象所在类的contains()方法
...
//        System.out.println(coll.contains(p)); // true
    ...
    public void test3(){
        ...
        // 5.retainAll(Collection coll1):交集: 获取当前集合与coll1集合的交集,并返回给当前集
//        Collection coll1 = Arrays.asList(123,456,789);
//        coll.retainAll(coll1);
//        System.out.println(coll);

        // 6.equals(Object obj):要想返回true判断当前集合和形参集合的元素都相同
        ...
        System.out.println(coll.equals(coll1)); // false 元素顺序不同
