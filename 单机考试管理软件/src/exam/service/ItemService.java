...
public class ItemService {
    ...
    private final String ITEM_FILENAME = "D:\\java工作空间(IDEA)\\javaSE练习项目\\单机考试管理软件\\Items.txt";//读取的文件位置
    private final String ANSWER_FILENAME = "D:\\java工作空间(IDEA)\\javaSE练习项目\\单机考试管理软件\\answer.dat";//文件输出的位置
